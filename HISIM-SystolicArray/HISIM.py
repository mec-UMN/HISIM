...
# Publish or stage the six editable input CSVs before any consumer reads them.
# Uploaded files live outside the simulator tree so users can safely keep a
# heterogeneous design while CREATE_DEFAULT_FILES is disabled.
